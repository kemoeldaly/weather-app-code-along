<template>
   <main class="container bg-primary text-white flex-1">
        <div class="pt-4 mb-8-relative">
           ...
           > 
           <!-- insert unordered for preview dropdown -->
           <ul 
               class="absloute bg-secondary text-white w-full shadow-md py-2 px-1 top-[66px]"
...
// preview requires get search results
const previewCity = (searchResult) => {
   // destructures the city and state separated by the 
